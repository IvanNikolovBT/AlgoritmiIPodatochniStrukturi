...
public class RootingHashJava {
    public static void main(String[] args) throws IOException {
        ...
        for(int i=1;i<=n;i++)
        {
            ...
            // da gi vnesam site ip i da proveram dali ima contains ako ima super ako ne toe so cbht treba
            table.insert(s,b);
...
//                table.insert(s,splitter[j]);
        ...
        for(int i=0;i<n;i++)
        {
            ...
            if(table.search(s)!=-1) {
                ...
                //System.out.println("vlegva i go pronajde interfejsot");
                stringBuilder.setLength(0);
                for(int j=0;j<3;j++)
                    stringBuilder.append(bsplit[j]).append(".");
                //System.out.println(stringBuilder.toString()+" STRINGBUILDERO TO SHO BARAME");
                //System.out.println(c+"   OVDE TREBA CONTAIN");
                if(c.contains(stringBuilder.toString()))
                {
