        ...
        for(i=0;i<N;i++)
        {
            ...
            switch(s[0])
            {
                case"CREATE":
                    ...
                    int a=tree.childCount(curr);
                    String []siblings=new String[a+1];
                    SLLNode<String> tmp=curr;
                    for(j=0;j<a;j++)
                    {
                       siblings[j]=tmp.element;
                       tmp=tmp.sibling;
                    }
                    siblings[a]=s[1];
                ...
                case "PATH":
                    ...
                    stringBuilder.append(tree.root.element+":\\");
