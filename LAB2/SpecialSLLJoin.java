...
public class SpecialSLLJoin<E> {
    ...
    public SLL<E> specialJoin(SLL<E> list1, SLL<E> list2)
    {
        ...
        while(tmp1!=null&&tmp2!=null&&tmp1.succ!=null&tmp2.succ!=null)
        {
            ...
            rezultat.insertLast(tmp1.succ.element);
            tmp1=tmp1.succ.succ;

            rezultat.insertLast(tmp2.element);
            rezultat.insertLast(tmp2.succ.element);
            tmp2=tmp2.succ.succ;
        }
        if(tmp1!=null)
        {
        ...
        System.out.println("vistinska dolzina e "+ (list1.size()+list2.size())+" dolzina e "+rezultat.size());
    return rezultat;
    }
